...
import { getFocusableElements, nextFocus, usePortal } from "src/utility/utils";
  ...
  return ReactDOM.createPortal(
    ...
    <div
      className={classNames(
        "fixed inset-0 z-10 p-8 text-white bg-gray-600/90 overflow-y-auto overflow-x-hidden",
        `${open ? "visible" : "invisible"}`
        // control visibility via `open` attribute (or render conditionally)
      )}
